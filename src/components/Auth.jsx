...
export default function Auth() {
  ...
  return (
    <div style={{
      ...
      background: `radial-gradient(ellipse at 50% 80%, var(--indigo) 0%, var(--midnight) 70%)`,
      padding: 24,
    }}>
      <div style={{ textAlign: "center", width: "100%", maxWidth: 400 }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <svg width="80" height="60" viewBox="0 0 80 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Basin (open book curving into bowl) */}
            ...
            {/* Mist ribbon 1 */}
            <path d="M32 32 C30 22 34 14 30 4" stroke="var(--lavender)" strokeWidth="2" opacity="0.5"
            ...
            {/* Mist ribbon 2 */}
            <path d="M50 30 C52 20 48 12 52 2" stroke="var(--lavender)" strokeWidth="2" opacity="0.4"
              strokeLinecap="round" fill="none">
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          />
          {error && (
            <p style={{ color: "#e88", fontSize: "0.85rem" }}>{error}</p>
          )}
